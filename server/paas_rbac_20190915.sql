...
--
-- Table structure for table `ac_goods`
--

DROP TABLE IF EXISTS `ac_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `ac_goods` (
  `id_goods` int(11) NOT NULL AUTO_INCREMENT,
  `id_website` int(11) NOT NULL,
  `id_goods_type` int(11) NOT NULL DEFAULT '0',
  `title` varchar(128) NOT NULL COMMENT '标题',
  `price` decimal(10,2) NOT NULL COMMENT '价格',
  `discount price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '折扣价格',
  `images` varchar(256) DEFAULT NULL COMMENT 'json 格式的图像名称列表，不包含路径',
  `description` varchar(2048) DEFAULT NULL COMMENT '描述',
  `quantity` int(11) DEFAULT '0' COMMENT '库存数量',
  `publish_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '上架日期',
  PRIMARY KEY (`id_goods`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ac_goods`
--

LOCK TABLES `ac_goods` WRITE;
/*!40000 ALTER TABLE `ac_goods` DISABLE KEYS */;
/*!40000 ALTER TABLE `ac_goods` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ac_goods_type`
--

DROP TABLE IF EXISTS `ac_goods_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `ac_goods_type` (
  `id_goods_type` int(11) NOT NULL AUTO_INCREMENT,
  `id_website` int(11) NOT NULL DEFAULT '0',
  `goods_type_name` varchar(45) NOT NULL,
  PRIMARY KEY (`id_goods_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ac_goods_type`
--

LOCK TABLES `ac_goods_type` WRITE;
/*!40000 ALTER TABLE `ac_goods_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `ac_goods_type` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-15 15:09:58
